...
public class BrickletGPS extends Device {
	...
	private final static int CALLBACK_COORDINATES = 17;
	private final static int CALLBACK_STATUS = 18;
	private final static int CALLBACK_ALTITUDE = 19;
	private final static int CALLBACK_MOTION = 20;
	private final static int CALLBACK_DATE_TIME = 21;
	 ...
	 * 
	 * The {@link BrickletGPS.CoordinatesListener} listener is only triggered if the coordinates changed
	 ...
	 * 
	 * The {@link BrickletGPS.StatusListener} listener is only triggered if the status changed since the
	 * last triggering.
	 */
	 ...
	 * 
	 * The {@link BrickletGPS.AltitudeListener} listener is only triggered if the altitude changed since
	 ...
	 * 
	 * The {@link BrickletGPS.MotionListener} listener is only triggered if the motion changed since the
	 ...
	 * 
	 * The {@link BrickletGPS.DateTimeListener} listener is only triggered if the date or time changed
