...
public class BrickServo extends Device {
	...
	private final static int CALLBACK_UNDER_VOLTAGE = 26;
	private final static int CALLBACK_POSITION_REACHED = 27;
	private final static int CALLBACK_VELOCITY_REACHED = 28;
	 ...
	 * {@link BrickServo#setSPITFPBaudrate(char, long)}. If the dynamic baudrate is disabled, the baudrate
	 * as set by {@link BrickServo#setSPITFPBaudrate(char, long)} will be used statically.
	 * 
	...
	/**
	 * Returns the baudrate config, see {@link BrickServo#setSPITFPBaudrateConfig(boolean, long)}.
	 * 
	 * .. versionadded:: 2.3.4$nbsp;(Firmware)
	 */
	 ...
	 * interference (see {@link BrickServo#getSPITFPErrorCount(char)}) you can decrease the
	 * baudrate.
	 * 
	 * If the dynamic baudrate feature is enabled, the baudrate set by this
	 * function corresponds to the maximum baudrate (see {@link BrickServo#setSPITFPBaudrateConfig(boolean, long)}).
	 * 
	...
	/**
	 * Returns the baudrate for a given Bricklet port, see {@link BrickServo#setSPITFPBaudrate(char, long)}.
	 * 
	 * .. versionadded:: 2.3.2$nbsp;(Firmware)
	 */
