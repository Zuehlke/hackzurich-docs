...
public class BrickletAmbientLight extends Device {
	...
	private final static int CALLBACK_ILLUMINANCE = 13;
	private final static int CALLBACK_ANALOG_VALUE = 14;
	private final static int CALLBACK_ILLUMINANCE_REACHED = 15;
	 ...
	 * 
	 * The {@link BrickletAmbientLight.IlluminanceListener} listener is only triggered if the illuminance has changed since the
	 * last triggering.
	 */
	 ...
	 * ambient light sensor.
	 * 
	 * The {@link BrickletAmbientLight.AnalogValueListener} listener is only triggered if the analog value has changed since the
	 * last triggering.
	 */
	 ...
	 * {@link BrickletAmbientLight.IlluminanceListener} listener and set the period with
	 ...
	 * {@link BrickletAmbientLight.AnalogValueListener} listener and set the period with
