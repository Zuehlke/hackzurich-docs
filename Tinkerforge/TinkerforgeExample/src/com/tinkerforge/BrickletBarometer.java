...
public class BrickletBarometer extends Device {
	...
	private final static int CALLBACK_AIR_PRESSURE = 15;
	private final static int CALLBACK_ALTITUDE = 16;
	private final static int CALLBACK_AIR_PRESSURE_REACHED = 17;
	private final static int CALLBACK_ALTITUDE_REACHED = 18;
	 ...
	 * {@link BrickletBarometer#setAirPressureCallbackPeriod(long)}. The parameter is the air
	 * pressure of the air pressure sensor.
	 * 
	 * The {@link BrickletBarometer.AirPressureListener} listener is only triggered if the air pressure has
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletBarometer#setAltitudeCallbackPeriod(long)}. The parameter is the altitude of
	 * the air pressure sensor.
	 * 
	 * The {@link BrickletBarometer.AltitudeListener} listener is only triggered if the altitude has changed since
	 * the last triggering.
	 */
	 ...
	 * {@link BrickletBarometer.AirPressureListener} listener and set the period with
	 ...
	 * {@link BrickletBarometer.AltitudeListener} listener and set the period with
