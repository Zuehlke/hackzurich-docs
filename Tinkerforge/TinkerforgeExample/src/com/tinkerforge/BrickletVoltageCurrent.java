...
public class BrickletVoltageCurrent extends Device {
	...
	private final static int CALLBACK_CURRENT = 22;
	private final static int CALLBACK_VOLTAGE = 23;
	private final static int CALLBACK_POWER = 24;
	private final static int CALLBACK_CURRENT_REACHED = 25;
	private final static int CALLBACK_VOLTAGE_REACHED = 26;
	private final static int CALLBACK_POWER_REACHED = 27;
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletVoltageCurrent.CurrentListener} listener is only triggered if the current has changed since
	 * the last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletVoltageCurrent#setVoltageCallbackPeriod(long)}. The parameter is the voltage of
	 * the sensor.
	 * 
	 * The {@link BrickletVoltageCurrent.VoltageListener} listener is only triggered if the voltage has changed since
	 * the last triggering.
	 */
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletVoltageCurrent.PowerListener} listener is only triggered if the power has changed since the
	 * last triggering.
	 */
	 ...
	 * {@link BrickletVoltageCurrent.CurrentListener} listener and set the period with
	 ...
	 * {@link BrickletVoltageCurrent.VoltageListener} listener and set the period with
	 ...
	 * {@link BrickletVoltageCurrent.PowerListener} listener and set the period with
