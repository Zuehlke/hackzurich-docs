...
public class BrickletMoisture extends Device {
	...
	private final static int CALLBACK_MOISTURE = 8;
	private final static int CALLBACK_MOISTURE_REACHED = 9;
	 ...
	 * {@link BrickletMoisture#setMoistureCallbackPeriod(long)}. The parameter is the
	 * moisture value of the sensor.
	 * 
	 * The {@link BrickletMoisture.MoistureListener} listener is only triggered if the moisture value has changed
	 ...
	 * to use the {@link BrickletMoisture.MoistureListener} listener and set the period with
