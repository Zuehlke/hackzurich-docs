...
public class BrickletDistanceIR extends Device {
	...
	private final static int CALLBACK_DISTANCE = 15;
	private final static int CALLBACK_ANALOG_VALUE = 16;
	private final static int CALLBACK_DISTANCE_REACHED = 17;
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletDistanceIR.DistanceListener} listener is only triggered if the distance has changed since the
	 * last triggering.
	 */
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletDistanceIR.AnalogValueListener} listener is only triggered if the analog value has changed
	 ...
	 * {@link BrickletDistanceIR.DistanceListener} listener and set the period with
	 ...
	 * {@link BrickletDistanceIR.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletDistanceIR.AnalogValueListener} listener is only triggered if the analog value has
