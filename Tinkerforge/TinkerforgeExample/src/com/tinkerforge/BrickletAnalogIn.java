...
public class BrickletAnalogIn extends Device {
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletAnalogIn.VoltageListener} listener is only triggered if the voltage has changed since
	 * the last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletAnalogIn#setAnalogValueCallbackPeriod(long)}. The parameter is the analog
	 * value of the sensor.
	 * 
	 * The {@link BrickletAnalogIn.AnalogValueListener} listener is only triggered if the voltage has changed
	 ...
	 * {@link BrickletAnalogIn.VoltageListener} listener and set the period with
	 ...
	 * {@link BrickletAnalogIn.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletAnalogIn.AnalogValueListener} listener is only triggered if the analog value has
