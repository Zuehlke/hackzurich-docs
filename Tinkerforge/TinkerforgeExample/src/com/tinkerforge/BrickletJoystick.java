...
public class BrickletJoystick extends Device {
	...
	private final static int CALLBACK_POSITION = 15;
	private final static int CALLBACK_ANALOG_VALUE = 16;
	private final static int CALLBACK_POSITION_REACHED = 17;
	private final static int CALLBACK_ANALOG_VALUE_REACHED = 18;
	private final static int CALLBACK_PRESSED = 19;
	private final static int CALLBACK_RELEASED = 20;
	 ...
	 * Joystick.
	 * 
	 * The {@link BrickletJoystick.PositionListener} listener is only triggered if the position has changed since the
	 * last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletJoystick#setAnalogValueCallbackPeriod(long)}. The parameters are the
	 * analog values of the Joystick.
	 * 
	 * The {@link BrickletJoystick.AnalogValueListener} listener is only triggered if the values have changed
	 ...
	 * {@link BrickletJoystick.PositionListener} listener and set the period with
	 ...
	 * {@link BrickletJoystick.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletJoystick.AnalogValueListener} listener is only triggered if the analog values have
