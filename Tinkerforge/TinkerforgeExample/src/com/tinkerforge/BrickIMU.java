...
public class BrickIMU extends Device {
	...
	private final static int CALLBACK_ACCELERATION = 31;
	private final static int CALLBACK_MAGNETIC_FIELD = 32;
	private final static int CALLBACK_ANGULAR_VELOCITY = 33;
	private final static int CALLBACK_ALL_DATA = 34;
	private final static int CALLBACK_ORIENTATION = 35;
	private final static int CALLBACK_QUATERNION = 36;
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickIMU#setMagneticFieldPeriod(long)}. The parameters are the magnetic
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickIMU#setAngularVelocityPeriod(long)}. The parameters are the angular
	 ...
	 * to use the {@link BrickIMU.AccelerationListener} listener and set the period with
	 ...
	 * to use the {@link BrickIMU.MagneticFieldListener} listener and set the period with
	 ...
	 * to use the {@link BrickIMU.AngularVelocityListener} listener and set the period with
	 ...
	 * to use the {@link BrickIMU.AllDataListener} listener and set the period with
	 ...
	 * to use the {@link BrickIMU.OrientationListener} listener and set the period with
	 ...
	 * to use the {@link BrickIMU.QuaternionListener} listener and set the period with
	...
	/**
	 * Sets the period in ms with which the {@link BrickIMU.MagneticFieldListener} listener is
	...
	/**
	 * Sets the period in ms with which the {@link BrickIMU.AngularVelocityListener} listener is
	 * triggered periodically. A value of 0 turns the listener off.
	 */
	 ...
	 * {@link BrickIMU#setSPITFPBaudrate(char, long)}. If the dynamic baudrate is disabled, the baudrate
	 * as set by {@link BrickIMU#setSPITFPBaudrate(char, long)} will be used statically.
	 * 
	...
	/**
	 * Returns the baudrate config, see {@link BrickIMU#setSPITFPBaudrateConfig(boolean, long)}.
	 * 
	 * .. versionadded:: 2.3.5$nbsp;(Firmware)
	 */
	 ...
	 * interference (see {@link BrickIMU#getSPITFPErrorCount(char)}) you can decrease the
	 * baudrate.
	 * 
	 * If the dynamic baudrate feature is enabled, the baudrate set by this
	 * function corresponds to the maximum baudrate (see {@link BrickIMU#setSPITFPBaudrateConfig(boolean, long)}).
	 * 
	...
	/**
	 * Returns the baudrate for a given Bricklet port, see {@link BrickIMU#setSPITFPBaudrate(char, long)}.
	 * 
	 * .. versionadded:: 2.3.3$nbsp;(Firmware)
	 */
