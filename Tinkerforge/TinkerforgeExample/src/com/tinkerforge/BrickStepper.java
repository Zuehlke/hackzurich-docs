...
public class BrickStepper extends Device {
	...
	private final static int CALLBACK_UNDER_VOLTAGE = 31;
	private final static int CALLBACK_POSITION_REACHED = 32;
	private final static int CALLBACK_ALL_DATA = 40;
	private final static int CALLBACK_NEW_STATE = 41;
	 ...
	 * voltage and the current consumption of the stepper motor.
	 * 
	 * There is also a listener for this function, see {@link BrickStepper.AllDataListener} listener.
	 */
	 ...
	 * {@link BrickStepper#setSPITFPBaudrate(char, long)}. If the dynamic baudrate is disabled, the baudrate
	 * as set by {@link BrickStepper#setSPITFPBaudrate(char, long)} will be used statically.
	 * 
	...
	/**
	 * Returns the baudrate config, see {@link BrickStepper#setSPITFPBaudrateConfig(boolean, long)}.
	 * 
	 * .. versionadded:: 2.3.6$nbsp;(Firmware)
	 */
	 ...
	 * interference (see {@link BrickStepper#getSPITFPErrorCount(char)}) you can decrease the
	 * baudrate.
	 * 
	 * If the dynamic baudrate feature is enabled, the baudrate set by this
	 * function corresponds to the maximum baudrate (see {@link BrickStepper#setSPITFPBaudrateConfig(boolean, long)}).
	 * 
	...
	/**
	 * Returns the baudrate for a given Bricklet port, see {@link BrickStepper#setSPITFPBaudrate(char, long)}.
	 * 
	 * .. versionadded:: 2.3.3$nbsp;(Firmware)
	 */
