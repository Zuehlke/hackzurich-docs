...
public class BrickletSoundIntensity extends Device {
	...
	private final static int CALLBACK_INTENSITY = 8;
	private final static int CALLBACK_INTENSITY_REACHED = 9;
	 ...
	 * {@link BrickletSoundIntensity#setIntensityCallbackPeriod(long)}. The parameter is the intensity
	 * of the sensor.
	 * 
	 * The {@link BrickletSoundIntensity.IntensityListener} listener is only triggered if the intensity has changed
	 ...
	 * {@link BrickletSoundIntensity.IntensityListener} listener and set the period with
