...
public class BrickletDistanceUS extends Device {
	...
	private final static int CALLBACK_DISTANCE = 8;
	private final static int CALLBACK_DISTANCE_REACHED = 9;
	 ...
	 * of the sensor.
	 * 
	 * The {@link BrickletDistanceUS.DistanceListener} listener is only triggered if the distance value has changed
	 ...
	 * use the {@link BrickletDistanceUS.DistanceListener} listener and set the period with
	 ...
	 * 
	 * Der {@link BrickletDistanceUS.DistanceListener} listener is only triggered if the distance value has changed
	 * since the last triggering.
	 * 
