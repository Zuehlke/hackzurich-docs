...
public class BrickletTemperature extends Device {
	 ...
	 * {@link BrickletTemperature#setTemperatureCallbackPeriod(long)}. The parameter is the
	 * temperature of the sensor.
	 * 
	 * The {@link BrickletTemperature.TemperatureListener} listener is only triggered if the temperature has changed
	 ...
	 * to use the {@link BrickletTemperature.TemperatureListener} listener and set the period with
