...
public class BrickletHallEffect extends Device {
	...
	private final static int CALLBACK_EDGE_COUNT = 10;
	 ...
	 * current count and the current value (see {@link BrickletHallEffect#getValue()} and
	 * {@link BrickletHallEffect#getEdgeCount(boolean)}).
	 * 
	 * The {@link BrickletHallEffect.EdgeCountListener} listener is only triggered if the count or value changed
	 ...
	 * 
	 * The {@link BrickletHallEffect.EdgeCountListener} listener is only triggered if the edge count has changed
	 * since the last triggering.
	 * 
