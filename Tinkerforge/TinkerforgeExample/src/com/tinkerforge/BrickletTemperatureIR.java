...
public class BrickletTemperatureIR extends Device {
	...
	private final static int CALLBACK_AMBIENT_TEMPERATURE = 15;
	private final static int CALLBACK_OBJECT_TEMPERATURE = 16;
	private final static int CALLBACK_AMBIENT_TEMPERATURE_REACHED = 17;
	private final static int CALLBACK_OBJECT_TEMPERATURE_REACHED = 18;
	 ...
	 * {@link BrickletTemperatureIR#setAmbientTemperatureCallbackPeriod(long)}. The parameter is the
	 * ambient temperature of the sensor.
	 * 
	 * The {@link BrickletTemperatureIR.AmbientTemperatureListener} listener is only triggered if the ambient
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletTemperatureIR#setObjectTemperatureCallbackPeriod(long)}. The parameter is the
	 * object temperature of the sensor.
	 * 
	 * The {@link BrickletTemperatureIR.ObjectTemperatureListener} listener is only triggered if the object
	 * temperature has changed since the last triggering.
	 */
	 ...
	 * to use the {@link BrickletTemperatureIR.AmbientTemperatureListener} listener and set the period with
	 ...
	 * to use the {@link BrickletTemperatureIR.ObjectTemperatureListener} listener and set the period with
	...
	/**
	 * Sets the period in ms with which the {@link BrickletTemperatureIR.AmbientTemperatureListener} listener is
	 * triggered periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletTemperatureIR.AmbientTemperatureListener} listener is only triggered if the temperature has
	...
	/**
	 * Sets the period in ms with which the {@link BrickletTemperatureIR.ObjectTemperatureListener} listener is
	 * triggered periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletTemperatureIR.ObjectTemperatureListener} listener is only triggered if the temperature
