...
public class BrickletPTC extends Device {
	...
	private final static int CALLBACK_TEMPERATURE = 13;
	private final static int CALLBACK_TEMPERATURE_REACHED = 14;
	private final static int CALLBACK_RESISTANCE = 15;
	private final static int CALLBACK_RESISTANCE_REACHED = 16;
	 ...
	 * {@link BrickletPTC#setTemperatureCallbackPeriod(long)}. The parameter is the
	 * temperature of the connected sensor.
	 * 
	 * The {@link BrickletPTC.TemperatureListener} listener is only triggered if the temperature has changed
	 ...
	 * 
	 * The {@link BrickletPTC.ResistanceListener} listener is only triggered if the resistance has changed
	 * since the last triggering.
	 */
	 ...
	 * to use the {@link BrickletPTC.TemperatureListener} listener and set the period with
	 ...
	 * to use the {@link BrickletPTC.ResistanceListener} listener and set the period with
	 ...
	 * 
	 * The {@link BrickletPTC.TemperatureListener} listener is only triggered if the temperature has
	...
	public void setResistanceCallbackThreshold(char option, int min, int max) throws TimeoutException, NotConnectedException {
		ByteBuffer bb = ipcon.createRequestPacket((byte)17, FUNCTION_SET_RESISTANCE_CALLBACK_THRESHOLD, this);
