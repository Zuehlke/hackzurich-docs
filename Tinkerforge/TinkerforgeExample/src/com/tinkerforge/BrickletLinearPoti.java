...
public class BrickletLinearPoti extends Device {
	 ...
	 * {@link BrickletLinearPoti#setPositionCallbackPeriod(long)}. The parameter is the position
	 * of the linear potentiometer.
	 * 
	 * The {@link BrickletLinearPoti.PositionListener} listener is only triggered if the position has changed
	 ...
	 * 
	 * The {@link BrickletLinearPoti.AnalogValueListener} listener is only triggered if the position has changed
	 * since the last triggering.
	 */
	 ...
	 * {@link BrickletLinearPoti.PositionListener} listener and set the period with
	 ...
	 * {@link BrickletLinearPoti.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletLinearPoti.AnalogValueListener} listener is only triggered if the analog value has
