...
public class BrickletCurrent12 extends Device {
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletCurrent12.CurrentListener} listener is only triggered if the current has changed since
	 * the last triggering.
	 */
	 ...
	 * of the sensor.
	 * 
	 * The {@link BrickletCurrent12.AnalogValueListener} listener is only triggered if the current has changed since the
	 * last triggering.
	 */
	 ...
	 * {@link BrickletCurrent12.CurrentListener} listener and set the period with
	 ...
	 * {@link BrickletCurrent12.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletCurrent12.AnalogValueListener} listener is only triggered if the analog value has
