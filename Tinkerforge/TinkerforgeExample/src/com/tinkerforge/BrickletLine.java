...
public class BrickletLine extends Device {
	...
	private final static int CALLBACK_REFLECTIVITY = 8;
	private final static int CALLBACK_REFLECTIVITY_REACHED = 9;
	 ...
	 * {@link BrickletLine#setReflectivityCallbackPeriod(long)}. The parameter is the
	 * reflectivity of the sensor.
	 * 
	 * The {@link BrickletLine.ReflectivityListener} listener is only triggered if the reflectivity has
	 ...
	 * to use the {@link BrickletLine.ReflectivityListener} listener and set the period with
