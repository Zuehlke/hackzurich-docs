...
public class BrickletRotaryPoti extends Device {
	...
	private final static int CALLBACK_POSITION = 13;
	private final static int CALLBACK_ANALOG_VALUE = 14;
	private final static int CALLBACK_POSITION_REACHED = 15;
	 ...
	 * {@link BrickletRotaryPoti#setPositionCallbackPeriod(long)}. The parameter is the position of
	 * the rotary potentiometer.
	 * 
	 * The {@link BrickletRotaryPoti.PositionListener} listener is only triggered if the position has changed since
	 * the last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletRotaryPoti#setAnalogValueCallbackPeriod(long)}. The parameter is the
	 * analog value of the rotary potentiometer.
	 * 
	 * The {@link BrickletRotaryPoti.AnalogValueListener} listener is only triggered if the position has changed
	 ...
	 * {@link BrickletRotaryPoti.PositionListener} listener and set the period with
	 ...
	 * {@link BrickletRotaryPoti.AnalogValueListener} listener and set the period with
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletRotaryPoti.AnalogValueListener} listener is only triggered if the analog value has
