...
public class BrickletCurrent25 extends Device {
	...
	private final static int CALLBACK_CURRENT = 15;
	private final static int CALLBACK_ANALOG_VALUE = 16;
	private final static int CALLBACK_CURRENT_REACHED = 17;
	private final static int CALLBACK_ANALOG_VALUE_REACHED = 18;
	private final static int CALLBACK_OVER_CURRENT = 19;
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletCurrent25.CurrentListener} listener is only triggered if the current has changed since the
	 * last triggering.
	 */
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletCurrent25.AnalogValueListener} listener is only triggered if the current has changed since the
	 * last triggering.
	 */
	 ...
	 * {@link BrickletCurrent25.CurrentListener} listener and set the period with
	 ...
	 * {@link BrickletCurrent25.AnalogValueListener} listener and set the period with
	 ...
	 * 
	 * The {@link BrickletCurrent25.CurrentListener} listener is only triggered if the current has changed since
	 * the last triggering.
	 * 
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletCurrent25.AnalogValueListener} listener is only triggered if the analog value has
