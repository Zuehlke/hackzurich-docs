...
public class BrickletIndustrialDual020mA extends Device {
	...
	private final static int CALLBACK_CURRENT = 10;
	private final static int CALLBACK_CURRENT_REACHED = 11;
	 ...
	 * sensor.
	 * 
	 * The {@link BrickletIndustrialDual020mA.CurrentListener} listener is only triggered if the current has changed since the
	 * last triggering.
	 */
	 ...
	 * {@link BrickletIndustrialDual020mA.CurrentListener} listener and set the period with
