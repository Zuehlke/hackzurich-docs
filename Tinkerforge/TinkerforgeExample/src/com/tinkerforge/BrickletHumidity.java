...
public class BrickletHumidity extends Device {
	...
	private final static int CALLBACK_HUMIDITY = 13;
	private final static int CALLBACK_ANALOG_VALUE = 14;
	private final static int CALLBACK_HUMIDITY_REACHED = 15;
	 ...
	 * {@link BrickletHumidity#setHumidityCallbackPeriod(long)}. The parameter is the humidity of
	 * the sensor.
	 * 
	 * The {@link BrickletHumidity.HumidityListener} listener is only triggered if the humidity has changed since
	 * the last triggering.
	 */
	...
	/**
	 * This listener is triggered periodically with the period that is set by
	 * {@link BrickletHumidity#setAnalogValueCallbackPeriod(long)}. The parameter is the analog
	 * value of the sensor.
	 * 
	 * The {@link BrickletHumidity.AnalogValueListener} listener is only triggered if the humidity has changed
	 ...
	 * {@link BrickletHumidity.HumidityListener} listener and set the period with
	 ...
	 * {@link BrickletHumidity.AnalogValueListener} listener and set the period with
	 ...
	 * 
	 * The {@link BrickletHumidity.HumidityListener} listener is only triggered if the humidity has changed
	 * since the last triggering.
	 * 
	 ...
	 * periodically. A value of 0 turns the listener off.
	 * 
	 * The {@link BrickletHumidity.AnalogValueListener} listener is only triggered if the analog value has
