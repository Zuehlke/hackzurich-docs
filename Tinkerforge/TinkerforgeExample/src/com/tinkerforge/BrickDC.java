...
public class BrickDC extends Device {
	...
	private final static int CALLBACK_UNDER_VOLTAGE = 21;
	private final static int CALLBACK_EMERGENCY_SHUTDOWN = 22;
	private final static int CALLBACK_VELOCITY_REACHED = 23;
	private final static int CALLBACK_CURRENT_VELOCITY = 24;
	 ...
	 * to 10000, the {@link BrickDC.VelocityReachedListener} listener will be triggered after about
	 ...
	 * {@link BrickDC#setCurrentVelocityPeriod(int)}. The parameter is the *current*
	 * velocity used by the motor.
	 * 
	 * The {@link BrickDC.CurrentVelocityListener} listener is only triggered after the set period
	 ...
	 * {@link BrickDC#setSPITFPBaudrate(char, long)}. If the dynamic baudrate is disabled, the baudrate
	 * as set by {@link BrickDC#setSPITFPBaudrate(char, long)} will be used statically.
	 * 
	...
	/**
	 * Returns the baudrate config, see {@link BrickDC#setSPITFPBaudrateConfig(boolean, long)}.
	 * 
	 * .. versionadded:: 2.3.5$nbsp;(Firmware)
	 */
	 ...
	 * interference (see {@link BrickDC#getSPITFPErrorCount(char)}) you can decrease the
	 * baudrate.
	 * 
	 * If the dynamic baudrate feature is enabled, the baudrate set by this
	 * function corresponds to the maximum baudrate (see {@link BrickDC#setSPITFPBaudrateConfig(boolean, long)}).
	 * 
	...
	/**
	 * Returns the baudrate for a given Bricklet port, see {@link BrickDC#setSPITFPBaudrate(char, long)}.
	 * 
	 * .. versionadded:: 2.3.3$nbsp;(Firmware)
	 */
